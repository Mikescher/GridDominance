...
{
	public class SimpleCyclicGameEntityOperation<TEntity> : GameEntityOperation<TEntity> where TEntity : GameEntity
	{
		...
		public SimpleCyclicGameEntityOperation(string n, float cycleTime, bool reliable, Action<TEntity, int> command) : base(n, null)
		{
			_cyleTime = cycleTime;
			_cmd = command;
			_reliable = reliable;
