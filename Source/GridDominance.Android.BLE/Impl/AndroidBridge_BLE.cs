...
using Android.OS;
using GridDominance.Android.Impl.Bluetooth;
...
{
	class AndroidBridge_BLE : IOperatingSystemBridge
	{
		...
		private readonly BLEBluetoothAdapter _bt;
		...
		public AndroidBridge_BLE(MainActivity a)
		{
			_activity = a;

			_iab = new AndroidBilling(a);
			_bt = new BLEBluetoothAdapter();
		}
