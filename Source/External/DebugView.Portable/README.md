FarseerPhysics.Portable (MonoGame DebugView)
============================================

Farseer Physics MonoGame DebugView compiled as a portable class library (PCL) against the PCL version of MonoGame.
...
*(should be used with [craftworkgames/FarseerPhysics.Portable](https://github.com/craftworkgames/FarseerPhysics.Portable/))*
