...
namespace GridDominance.Shared.Screens.Common
{
	public static class DebugUtils
	{
		...
		public static DebugTextDisplay CreateDisplay(GameScreen scrn)
		{
			...
			debugDisp.AddLine("ShowInfos",     () => $"Device = {MainGame.Inst.GDBridge.DeviceName} | Version = {MainGame.Inst.GDBridge.DeviceVersion} | App = {GDConstants.Version}[{MainGame.Flavor}] | Debugger = {Debugger.IsAttached}");
		...
		private static void DoDirectProtocolDebugTest2()
		{
			var lvl = Levels.LEVELS[Guid.Parse("{b16b00b5-0001-4000-0000-000003000031}")];
