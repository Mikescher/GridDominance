...
function GetSCCMLevelMetadataRecalculated($levelid)
{
	...
	$recalc['d0_bestuserid'] = sql_query_num_prep('GetSCCMLevelMetadataRecalculated', 'SELECT userid FROM userlevels_highscores WHERE levelid=:lid AND d0_time IS NOT NULL ORDER BY d0_time ASC LIMIT 1', [[':lid', $levelid, PDO::PARAM_INT]], 0);
	$recalc['d1_bestuserid'] = sql_query_num_prep('GetSCCMLevelMetadataRecalculated', 'SELECT userid FROM userlevels_highscores WHERE levelid=:lid AND d1_time IS NOT NULL ORDER BY d1_time ASC LIMIT 1', [[':lid', $levelid, PDO::PARAM_INT]], 0);
	$recalc['d2_bestuserid'] = sql_query_num_prep('GetSCCMLevelMetadataRecalculated', 'SELECT userid FROM userlevels_highscores WHERE levelid=:lid AND d2_time IS NOT NULL ORDER BY d2_time ASC LIMIT 1', [[':lid', $levelid, PDO::PARAM_INT]], 0);
	$recalc['d3_bestuserid'] = sql_query_num_prep('GetSCCMLevelMetadataRecalculated', 'SELECT userid FROM userlevels_highscores WHERE levelid=:lid AND d3_time IS NOT NULL ORDER BY d3_time ASC LIMIT 1', [[':lid', $levelid, PDO::PARAM_INT]], 0);
