...
namespace GridDominance.Shared.Screens.WorldMapScreen.Agents
{
	class WorldMapDragAgent : GameScreenAgent
	{
		...
		public static readonly FRectangle BOUNDING = new FRectangle(-16 * GDGameScreen.TILE_WIDTH, -8 * GDGameScreen.TILE_WIDTH, 48 * GDGameScreen.TILE_WIDTH, 48 * GDGameScreen.TILE_WIDTH);
