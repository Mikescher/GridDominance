...
{
	public class LeaveTransitionGameEndAgent : DecayOperation<GDWorldMapScreen>
	{
		...
		public LeaveTransitionGameEndAgent(bool slower, WarpGameEndNode node) : base(slower ? DURATION_SLOW : DURATION)
		{
			_node = node;
		}
