...
namespace GridDominance.Shared.Resources
{
	public static class L10NImpl
	{
		...
		public static void Init(int lang)
		{
			...
			L10N.Add(STR_GLOB_EXITTOAST,         "Click again to exit game",                                                                                                                "Drücke nochmal \"Zurück\" um das Spiel zu beenden");
			...
			L10N.Add(STR_HINT_001,               "Tip: Shoot stuff to win!",                                                                                                                "Tipp: Versuche auf die andere Kanone zu schiessen");
			...
			L10N.Add(STR_HINT_006,               "Try dragging the map around",                                                                                                             "Versuche mal die Karte zu verschieben");
			...
			L10N.Add(STR_INFOTOAST_2,            "The global best time is {0}",                                                                                                             "Die globale Bestzeit ist {0}");
			...
			L10N.Add(STR_MP_BTADAPTERPERMDENIED, "Missing bluetooth permission",                                                                                                            "Bluetooth Berechtigung wurde nicht gewährt");
			...
			L10N.Add(STR_MENU_CAP_LOBBY,         "Multiplayer Lobby",                                                                                                                       "Lobby");
			...
			L10N.Add(STR_BTN_YES,                "Yes",                                                                                                                                     "OK");
			L10N.Add(STR_BTN_NO,                 "No",                                                                                                                                      "Nein");
